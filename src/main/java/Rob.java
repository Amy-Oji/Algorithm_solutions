...
class Rob {
    /**
     * From Leetcode: https://leetcode.com/problems/house-robber/
     *
    ...
    public static void main(String[] args) {
        int[] nums1 = {1, 2, 3, 1};
        System.out.println("Example 1 == "+rob(nums1)); // should output 4

        int[] nums2 = {2,7,9,3,1};
        System.out.println("Example 1 == "+rob(nums2)); // should output 12
